...
import { useRegisterUserMutation } from "@/redux/feature/auth/auth.api";
import type { ICerateRequest } from "@/types";
...
const registerSchema = z
  .object({
    ...
    password: z
      .string()
      .min(6, { error: "Password should contain 6 character" }),
    confirmPassword: z
      .string()
      .min(6, { error: "Password should contain 6 character" }),
...
const RegisterForm: React.FC<Props> = () => {
  const [register, { isLoading: userLoading }] = useRegisterUserMutation();
  ...
  return (
    <div className={"flex flex-col gap-6"}>
      ...
      <div className="grid gap-6">
        ...
        <Button variant="outline" className="w-full" disabled={userLoading}>
          Login with Google
        </Button>
      </div>
